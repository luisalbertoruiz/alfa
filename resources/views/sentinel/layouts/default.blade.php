	      ...
	      <div class="container">
	        ...
	        <div class="collapse navbar-collapse">
	          ...
	          <ul class="nav navbar-nav navbar-right">
				...
				@else
				<li {{ (Request::is('login') ? 'class="active"' : '') }}><a href="{{ route('sentinel.login') }}">Ingresar</a></li>
				<li {{ (Request::is('users/create') ? 'class="active"' : '') }}><a href="{{ route('sentinel.register.form') }}">Registrarse</a></li>
				@endif
	          </ul>
	        </div><!--/.nav-collapse -->
	      </div>
